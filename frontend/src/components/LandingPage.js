...
const LandingPage = ({ onNavigateToFrontPage }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-glass-gradient px-4 overflow-hidden">
      {/* Background elements - enhanced with texture and colored spots */}
      <div className="absolute inset-0 z-0">
        ...
        {/* Animated glow spots - enhanced with varied colors */}
      ...
      >
        <div className="text-center mb-8">
          <div className="w-24 h-24 glass-glow rounded-full flex items-center justify-center mx-auto -mt-20 shadow-xl border-4 border-blue-400/30 pulse-glow">
            <div className="text-4xl bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent animate-pulse">
              📊
            </div>
          </div>
          <h1 className="text-4xl font-bold bg-gradient-text mt-6">
            Veltrix
          </h1>
